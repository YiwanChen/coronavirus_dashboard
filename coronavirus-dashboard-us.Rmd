...
### **Daily cumulative cases by type** (NZ only)
...
#----------------------------------------
# Plotting the data
names(daily_confirmed)<-stringr::str_replace_all(names(daily_confirmed), c(" " = "." , "," = "" ))
...
This Coronavirus dashboard: the case of US provides an overview of the 2019 Novel Coronavirus COVID-19 (2019-nCoV) epidemic for US. This dashboard is built with R using the R Makrdown framework and was initially adapted from this [dashboard](https://ramikrispin.github.io/coronavirus_dashboard/){target="_blank"} by Rami Krispin and then by this [dashboard](https://www.antoinesoetewey.com/files/coronavirus-dashboard.html){target="_blank"} by Antoine Soetewey.
